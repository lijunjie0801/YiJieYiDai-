...
- (id)initWithText:(NSString *)text_{
    if (self = [super init]) {
        ...
        CGRect textSize = [text boundingRectWithSize:CGSizeMake(280, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:font} context:nil];
...
+ (void)showWithText:(NSString *)text_
    ...
    CToast *toast = [[CToast alloc] initWithText:text_];
